...
On a fresh install, the sidebar opens to an **onboarding panel** that walks you through the steps below. Once one repo is enabled, every newly opened workspace auto-enables in the background — clicking **Disable** is recorded as a durable opt-out and respected on every subsequent activation.
