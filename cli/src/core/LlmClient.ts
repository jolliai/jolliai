...
// `hasLlmCredentials` is defined in the dependency-free LlmCredentials leaf so
// LLM-free bundles (e.g. SessionStartHook) can share it without inlining this
// module's @anthropic-ai/sdk runtime. Re-exported here so existing
// generation-side importers keep importing it from LlmClient unchanged.
export { hasLlmCredentials } from "./LlmCredentials.js";
