...
- [313 — IntelliJ Source Presentation Table](313-intellij-source-presentation-table.md) — one table mapping every reference source this host knows — a set now narrower than the shared catalogue — to its badge letter, brand hue and label, plus the label-composition policy its consuming panels share.
