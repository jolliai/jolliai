...
- [310 — Per-Repo Outbound-Push Control](310-per-repo-outbound-push-control.md) — a machine-global, identity-keyed record of which repositories may not push outbound, the one predicate every outbound path consults, and a current-repo toggle on every control surface.
