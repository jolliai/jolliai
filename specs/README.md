...
- [359 — Memory Bank Duplicate-Folder Consolidation](359-memory-bank-duplicate-folder-consolidation.md) — fold the several folders holding one repository into a single survivor, chosen by comparing each folder's set of stored memories against the system of record, and merge in what only the losers held.
