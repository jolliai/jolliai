...
- [13 — Squash Consolidation Summary](13-squash-consolidation-summary.md) — consolidate N source summaries into one via an LLM call, falling back to content-preserving mechanical concatenation on failure.
