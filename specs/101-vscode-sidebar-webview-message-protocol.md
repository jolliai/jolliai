...
| Field            | Meaning                                                                                                       |
| ---------------- | ------------------------------------------------------------------------------------------------------------- |
| `enabled`        | Whether JolliMemory is currently enabled in this repository.                                                  |
...
| `enabled:changed`             | `{ enabled }`                                                                                    | After enable/disable so the disabled banner shows or hides without an extension reload.                 |
