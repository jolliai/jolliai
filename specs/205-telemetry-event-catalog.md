...
| `push_enabled` | Outbound push re-enabled for a repo (the per-repo push control, spec 310). | `trigger` (discriminator). |
| `push_disabled` | Outbound push disabled for a repo (the per-repo push control, spec 310). | `trigger` (discriminator). |
