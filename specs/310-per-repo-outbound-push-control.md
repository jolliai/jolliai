...
- The control surfaces — the command line, the desktop editor's settings, the JVM host's settings, and the local dashboard's settings modal — and the shared engine behind all of them.
