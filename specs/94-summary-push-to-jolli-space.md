...
6. On `409` with `error: "binding_already_exists"`, surface the body verbatim as a binding-already-exists error so the chooser flow can resolve it gracefully. See **Binding Required Flow**.
