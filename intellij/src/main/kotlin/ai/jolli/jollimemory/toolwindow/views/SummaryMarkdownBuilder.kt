...
object SummaryMarkdownBuilder {
    ...
    /** Appends the standard "Generated by JolliMemory" footer with optional provider attribution. */
    internal fun pushFooter(lines: MutableList<String>, summary: CommitSummary) {
        val generatedAt = formatFullDate(java.time.Instant.now().toString())
        val providerSuffix = SummaryHtmlBuilder.formatProviderLabel(summary)?.let { " \u00b7 via $it" } ?: ""
        lines.addAll(listOf("", "---", "", "*Generated by JolliMemory \u00b7 $generatedAt$providerSuffix*"))
    }
}
