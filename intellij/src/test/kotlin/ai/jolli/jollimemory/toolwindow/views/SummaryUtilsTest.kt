...
class SummaryUtilsTest {
    ...
    inner class BuildPanelTitle {
        ...
        fun `includes ticket from summary`() {
            ...
            SummaryUtils.buildPanelTitle(summary) shouldContain "JOLLI-123"
        }
        ...
        fun `extracts ticket from commit message`() {
            val summary = CommitSummary(
                commitHash = "abc1234567890",
                commitMessage = "Fixes JOLLI-456: Fix bug",
                commitAuthor = "Alice",
                commitDate = "2026-01-15T10:00:00Z",
                branch = "main",
                generatedAt = "2026-01-15T10:00:00Z",
            )
            SummaryUtils.buildPanelTitle(summary) shouldContain "JOLLI-456"
        }
        ...
        fun `extracts ticket from branch name`() {
            val summary = CommitSummary(
                ...
                commitAuthor = "Alice",
                commitDate = "2026-01-15T10:00:00Z",
                branch = "feature/jolli-789-something",
                generatedAt = "2026-01-15T10:00:00Z",
            )
            SummaryUtils.buildPanelTitle(summary) shouldContain "JOLLI-789"
        }
    }
