...
- **Issue, page & conversation references** — Linear, Jira, GitHub, Notion, Slack, and Zoom items mentioned in your AI conversations are captured and attached to the relevant memory, and follow the commit through squash / rebase.
