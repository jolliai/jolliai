...
# same-version republish leaves the version-stamped copy under
# ~/.codex/plugins/cache/ untouched.
#
...
publish_git_repo "$DEST" "jolli-plugin-dev/jolli-chatgpt-plugin" dev
