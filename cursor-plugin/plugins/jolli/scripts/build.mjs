...
// entries that never resolve through dist-paths/: CursorPluginBootstrapHook, which
// the manifest launches directly, and DashboardServerEntry, which Cli.js spawns by
// name).
